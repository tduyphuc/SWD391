package com.hotel.swd.hotel.admin.requester;
...
public class Requester {
    ...
    public Response postReqRaw(List<String> reqPath, String rawBody) throws IOException {
        OkHttpClient client = new OkHttpClient();
        HttpUrl url = getFullUrl(reqPath, null);
        RequestBody requestBody = RequestBody.create(MediaType.parse("text/html"), rawBody);
