...
public class RoomInfoService implements IRoomInfo {
	...
	public String getAllService(String typeId) {
		Set<model.entity.Service> services = repo.getServices(Integer.valueOf(typeId));
		if(services == null){
	...
	private String getServiceMap(Set<model.entity.Service> services){
		List<Map<String, String>> maps = new LinkedList<Map<String, String>>();
		for(model.entity.Service service : services){
			Map<String, String> map = new HashMap<>();
