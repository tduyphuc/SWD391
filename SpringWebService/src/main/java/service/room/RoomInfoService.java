...
public class RoomInfoService implements IRoomInfo {
	...
	public String getAllService(String typeId) {
		Set<data.entity.Service> services = repo.getServices(Integer.valueOf(typeId));
		if(services == null){
	...
	private String getServiceMap(Set<data.entity.Service> services){
		List<Map<String, String>> maps = new LinkedList<Map<String, String>>();
		for(data.entity.Service service : services){
			Map<String, String> map = new HashMap<>();
